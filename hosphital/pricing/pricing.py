...
def update_billing_models(method, apply_by, amount, percentage):

    treatment = treatment_charges.objects.all()
    lab = lab_charges.objects.all()
    consultant = consultant_charges.objects.all()
    room = room_master.objects.all()
